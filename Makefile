...
OBJS=amazon.o mydatastore.o db_parser.o product_parser.o product.o user.o util.o book.o clothing.o movie.o
...
mydatastore.o: mydatastore.cpp mydatastore.h datastore.h util.h product.h user.h
